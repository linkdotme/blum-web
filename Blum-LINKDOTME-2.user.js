// ==UserScript==
// @name         Blum LinkDotMe_2
// @version      3.9
// @namespace    LINKDOTME
// @author       @SendTicket
// @match        https://telegram.blum.codes/*
// @grant        none
// @icon         https://sitzo.ir/blum/LINKDOTME.jpg
// @downloadURL  https://github.com/linkdotme/blum-web/raw/refs/heads/main/Blum-LINKDOTME-2.user.js
// @updateURL    https://github.com/linkdotme/blum-web/raw/refs/heads/main/Blum-LINKDOTME-2.user.js
// @homepage     https://github.com/linkdotme/blum-web
// ==/UserScript==
...
"https://raw.githubusercontent.com/linkdotme/blum-web/refs/heads/main/answers/codes.json"
...
function claimDailyReward() {
    ...
    if (widget) {
        ...
        if (claimButton) {
            claimButton.click();
            console.log('پاداش روزانه گرفته شده است!');
        } else {
        }
    } else {
    }
...
try {
	...
	githubButton.href = 'https://github.com/linkdotme/blum-web/';
	...
	telegramButton.href = 'https://t.me/LinkDotMe';
	...
	donateButton.href = 'https://sitzo.ir/blum/bankmeli.html';
